...
public class TinyDB {
    ...
    public ArrayList<FlowerDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FlowerDomain> playerList =  new ArrayList<FlowerDomain>();

        for(String jObjString : objStrings){
            FlowerDomain player  = gson.fromJson(jObjString,  FlowerDomain.class);
    ...
    public void putListObject(String key, ArrayList<FlowerDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FlowerDomain player: playerList){
